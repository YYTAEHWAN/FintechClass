...
const ModalCard = ({ bankName, fintechUseNo, tofintechno }) => {
  ...
  const [twoLeggedToken, setTwoLeggedToken] = useState("");
  ...
  const deposit = () => {
    ...
    const sendData = {
      ...
      "req_list": [
          {
          "tran_no": "1",
          "bank_tran_id": "M202200359U000000050",
          "fintech_use_num": tofintechno, //"120220035988941008441112",
          "print_content": "캐시백드립니다",
          "tran_amt": "888",
          "req_client_name": "홍길동",
          "req_client_bank_code": "097",
          "req_client_fintech_use_num": tofintechno, // "00012300000678", // 이건 모르겠다
          "req_client_num": "H1234",
